						...
						<form action="" onSubmit={handleRegister}>
							<div className="grid w-full my-6 items-center gap-1.5">
								...
								<Input
									type="text"
									name="fullName"
									className={`w-full h-12 bg-[#ecebf382] text-base ${inputValidity.fullName ? "bg-[#fddddd]" : ""
										}`}
							...
							<div className="grid w-full my-6 items-center gap-1.5">
								...
								<Input
									type="email"
									name="email"
									className={`w-full h-12 bg-[#ecebf382] text-base ${inputValidity.email ? "bg-[#fddddd]" : ""
										}`}
								...
								<Popover open={open} onOpenChange={setOpen}>
									<PopoverTrigger asChild>
										<Button
											...
											role="combobox"
											aria-expanded={open}
											className={`w-full h-12 justify-between text-base bg-[#ecebf382] ${inputValidity.occupation ? "bg-[#fddddd]" : ""
												}`}
										>
											{value
												? occupations.find(
							...
							<div className="grid w-full my-6 items-center gap-1.5">
								...
								<Input
									type="password"
									name="password"
									className={`w-full h-12 text-base bg-[#ecebf382] ${inputValidity.password ? "bg-[#fddddd]" : ""
										}`}
