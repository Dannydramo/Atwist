						...
						<form action="" onSubmit={handleClientSubmit}>
							<div className="grid w-full my-6 items-center gap-1.5">
								...
								<Input
									type="text"
									name="fullName"
									className={`w-full text-base h-12 bg-[#ecebf382] ${inputValidity.fullName ? "bg-[#fddddd]" : ""
										}`}
							...
							<div className="grid w-full my-6 items-center gap-1.5">
								...
								<Input
									type="email"
									name="email"
									className={`w-full h-12 text-base bg-[#ecebf382] ${inputValidity.email ? "bg-[#fddddd]" : ""
										}`}
							...
							<div className="grid w-full my-6 items-center gap-1.5">
								...
								<Input
									type="password"
									name="password"
									className={`w-full text-base h-12 bg-[#ecebf382] ${inputValidity.password ? "bg-[#fddddd]" : ""
										}`}
